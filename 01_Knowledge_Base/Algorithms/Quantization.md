...
The idea arises from the need to run inference on hardware without efficient floating-point units. The foundational work by Jacob et al. (2017) defines the 8-bit affine quantization scheme and quantization-aware training, which later became the standard adopted by TensorFlow Lite and CMSIS-NN. From here the line of research branched toward more aggressive precisions (4-bit, binary/ternary) and toward layer-by-layer mixed precision.
